...
var fastifyMetrics = require('fastify-metrics');
...
var swaggerUiDist = _interopDefault(require('swagger-ui-dist'));
var querysearch = require('@henry781/querysearch');
var _accepts = require('accepts');
var _flatstr = require('flatstr');
...
exports.AuthProvider = __decorate([
...
class AuthUtil {
    static parseAuthorizationHeader(request) {
        ...
        return authHeader.parse(request.headers.authorization);
    }
...
const environment = {
    ...
    LOG_PRETTY: process.env.LOG_PRETTY ? tipify.tryParseBoolean(process.env.LOG_PRETTY) : false,
...
exports.Principal = class Principal {
    constructor(options) {
        if (options) {
...
__decorate([
    tipify.jsonProperty('login'),
    __metadata("design:type", String)
], exports.Principal.prototype, "_login", void 0);
__decorate([
    tipify.jsonProperty('email'),
    __metadata("design:type", String)
], exports.Principal.prototype, "_email", void 0);
__decorate([
    tipify.jsonProperty('firstname'),
    __metadata("design:type", String)
], exports.Principal.prototype, "_firstname", void 0);
__decorate([
    tipify.jsonProperty('lastname'),
    __metadata("design:type", String)
], exports.Principal.prototype, "_lastname", void 0);
__decorate([
    tipify.jsonProperty('roles', tipify.arrayOf(String)),
    __metadata("design:type", Array)
], exports.Principal.prototype, "_roles", void 0);
__decorate([
    tipify.jsonProperty('params', tipify.keyValueOf(String, tipify.any())),
    __metadata("design:type", Object)
], exports.Principal.prototype, "_params", void 0);
exports.Principal = __decorate([
    tipify.jsonObject(),
    __metadata("design:paramtypes", [Object])
], exports.Principal);

class BasicAuthProvider extends exports.AuthProvider {
...
class JwtAuthProvider extends exports.AuthProvider {
    ...
    authenticate(request, token, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const decodedToken = jwt.verify(jwtToken, this._certificate);
...
const jsonConverter = new tipify.JsonConverter({
...
function getLogger(method, module) {
    const session = clsHooked.getNamespace('app');
...
exports.GenericClient = class GenericClient {
    constructor() {
    ...
    buildHttpOptions(options, method) {
        ...
        if (options.token) {
            ...
            httpOptions.headers.Authorization = authHeader.format(options.principal.token);
        }
        if (options.body) {
...
exports.GenericClient = __decorate([
    inversify.injectable(),
    __metadata("design:paramtypes", [])
], exports.GenericClient);
const genericClient = new exports.GenericClient();
...
let AdminController = AdminController_1 = class AdminController {
    ...
    static decorateMethods(options) {
        ...
        inversify.decorate(httpPut({ url: 'logging/level/:level', auth }), AdminController_1.prototype, 'setLoggingLevel');
        inversify.decorate(httpPut({ url: 'inspector/enabled', auth }), AdminController_1.prototype, 'enableInspector');
        inversify.decorate(httpPut({ url: 'inspector/disabled', auth }), AdminController_1.prototype, 'disableInspector');
    }
...
exports.HealthcheckController = class HealthcheckController {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], exports.HealthcheckController.prototype, "check", null);
exports.HealthcheckController = __decorate([
    controller('/healthcheck'),
    __param(0, inversify.multiInject(types.Healthcheck)), __param(0, inversify.optional()),
    __metadata("design:paramtypes", [Array])
], exports.HealthcheckController);

const clsNamespace = clsHooked.createNamespace('app');
...
exports.MongoService = MongoService_1 = class MongoService {
    constructor(logger) {
    ...
    connect(options = DEFAULT_MONGO_OPTIONS) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            mongodb.Logger.setCurrentLogger((msg, state) => {
                this.logger.debug(msg, state);
            });
            try {
                this.client = yield mongodb.MongoClient.connect(options.uri, options.client);
    ...
    doAction(action) {
        if (this.error) {
            ...
            throw new mongodb.MongoError('database is not ready');
        }
        else {
            return action();
        }
    ...
    find(type, query = {}, sort = {}, limit, offset) {
        ...
        return this.doAction(() => {
            ...
            .then((json) => jsonConverter.deserialize(json, tipify.arrayOf(type)));
    }
    aggregate(type, pipeline, options, outputType = type) {
        ...
        return this.doAction(() => {
            ...
            .then((json) => outputType ? jsonConverter.deserialize(json, tipify.arrayOf(outputType)) : json);
    }
    search(type, search) {
...
exports.MongoService = MongoService_1 = __decorate([
    inversify.injectable(),
    __param(0, inversify.inject(types.Logger)),
    __metadata("design:paramtypes", [typeof (_a = typeof _pino.Logger !== "undefined" && _pino.Logger) === "function" ? _a : Object])
...
exports.MongoHealthcheck = class MongoHealthcheck {
...
exports.MongoHealthcheck = __decorate([
    inversify.injectable(),
    __param(0, inversify.inject(types.MongoService)),
    __metadata("design:paramtypes", [exports.MongoService])
], exports.MongoHealthcheck);

const objectIdCustomConverter = {
    deserialize(obj) {
        if (!obj || obj instanceof bson.ObjectId) {
            return obj;
        }
        else if (typeof (obj) === 'string') {
            return new bson.ObjectId(obj);
        }
        else {
            throw new tipify.JsonConverterError('cannot deserialize to object id');
        }
    },
    serialize(obj) {
        if (!obj) {
...
class SwaggerTipifyUtil {
    static buildOpenApiSchema(type, schemas) {
        const c = tipify.normalizeConverterAndArgs(type);
        if (c.converter === tipify.stringConverter) {
            return { type: 'string' };
        }
        else if (c.converter === tipify.numberConverter) {
            return { type: 'number' };
        }
        else if (c.converter === tipify.booleanConverter) {
            return { type: 'boolean' };
        }
        else if (c.converter === tipify.arrayConverter) {
            if (!c.args) {
                return { type: 'array' };
            }
            const itemConverterDefinition = tipify.normalizeConverterAndArgs(c.args.itemConverter);
            return {
                items: SwaggerTipifyUtil.buildOpenApiSchema(itemConverterDefinition, schemas),
                type: 'array',
            };
        }
        else if (c.converter === tipify.objectConverter) {
            if (!c.args) {
                return { type: 'object' };
            }
            const objectType = c.args.type;
            const mapping = tipify.JsonConverterMapper.getMappingForType(objectType);
            if (!mapping) {
                return { type: 'object' };
            }
        ...
        return (request, reply) => __awaiter(this, void 0, void 0, function* () {
            const args = endpoint.paramsOptions.map((param) => {
                switch (param.type) {
                    ...
                    case 'search':
                        try {
                            return querysearch.QuerySearch.fromQueryParams(request.query);
                        }
                        catch (err) {
...
class Server {
    ...
    buildInstance(options) {
        ...
        if (options.healthcheck !== false) {
            options.container.bind(types.Controller).to(exports.HealthcheckController).inSingletonScope();
        }
        if (options.admin) {
        ...
        if (options.mongo) {
            options.container.bind(types.MongoService).to(exports.MongoService).inSingletonScope();
            options.container.bind(types.Healthcheck).to(exports.MongoHealthcheck).inSingletonScope();
...
exports.DEFAULT_BASIC_AUTH_PROVIDER_OPTIONS = DEFAULT_BASIC_AUTH_PROVIDER_OPTIONS;
exports.DEFAULT_JWT_AUTH_PROVIDER_OPTIONS = DEFAULT_JWT_AUTH_PROVIDER_OPTIONS;
exports.DEFAULT_LOGGER_OPTIONS = DEFAULT_LOGGER_OPTIONS;
exports.DEFAULT_MONGO_OPTIONS = DEFAULT_MONGO_OPTIONS;
exports.GenericClientError = GenericClientError;
exports.JwtAuthProvider = JwtAuthProvider;
exports.MONGO_COLLECTION = MONGO_COLLECTION;
exports.OPENAPI_DEFAULT_CONFIGURATION = OPENAPI_DEFAULT_CONFIGURATION;
exports.ROUTE_CONTROLLER = ROUTE_CONTROLLER;
...
exports.objectIdCustomConverter = objectIdCustomConverter;
